...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a=null ;//= context.obtainStyledAttributes(attrs, R.styleable.SwipeLayout);
        int dragEdgeChoices =1 ;//= a.getInt(R.styleable.SwipeLayout_drag_edge, DRAG_RIGHT);
       ...
       // mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a.getDimension(R.styleable.SwipeLayout_bottomEdgeSwipeOffset, 0);
        ...
        int ordinal =1;//= a.getInt(R.styleable.SwipeLayout_show_mode, ShowMode.PullOut.ordinal());
